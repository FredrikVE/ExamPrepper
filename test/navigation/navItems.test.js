...
import { PAGE_NAV_TOOL_IDS, PAGE_NAV_TOOL_ITEMS, SIDEBAR_NAV_ITEMS, getExamSelectPageNavToolItems } from "../../src/navigation/navItems.js";
...
describe("navItems", () => {
    ...
    test("returns exam-select page navigation tools", () => {
