...
export default function ProgressDot({ entryNumber, isActive, showEntryOutcome, isCorrect, onClick, goToEntryLabel, dotDisplayMode }) {
	return (
		<button
			type="button"
			onClick={onClick}
			className={getProgressDotClassName(isActive, showEntryOutcome, isCorrect, dotDisplayMode)}
