...
export default function LearningPathModuleDetail({ model, onActionPressed, onChapterTestSelected }) {
	return (
		<section className="learning-path-module-detail" aria-labelledby={model.headingId}>
			...
			<div className="learning-path-module-detail__sections">{model.sections.map((section) => <LearningPathSection key={section.id} model={section} onChapterTestSelected={onChapterTestSelected} />)}</div>
