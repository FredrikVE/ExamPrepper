	...
	return (
		<section className={`learning-session-result learning-session-result--${appearance}`} aria-labelledby="learning-session-result-title">
			<div className="learning-session-result__intro">
				<div className="learning-session-result__mark" aria-hidden="true"><ResultMark appearance={appearance} /></div>
			...
			<div className="learning-session-result__stats" aria-label={statsLabel}>
				<div><strong>{pointsValue}</strong><span>{pointsLabel}</span></div>
				<span className="learning-session-result__stats-divider" aria-hidden="true" />
				<div><strong>{scoreValue}</strong><span>{scoreLabel}</span></div>
			</div>
			...
			<div className="learning-session-result__actions learning-session-result__actions--single">
				<button className="learning-session-result__continue" type="button" disabled={isPrimaryDisabled} onClick={onPrimary}><span>{primaryLabel}</span><ArrowRight aria-hidden="true" /></button>
			</div>
		</section>
	);
}
