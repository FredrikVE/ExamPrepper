//src/ui/view/components/ExamPage/QuestionCard/DragDrop/Feedback/DragDropFeedbackCard.jsx
import { getTargetStatus } from "../Logic/dragDropAnswerLogic.js";
import DragDropFeedbackExplanation from "./DragDropFeedbackExplanation.jsx";
import DragDropFeedbackExpandButton from "./DragDropFeedbackExpandButton.jsx";
import { getAnswerText, getExtendedPoints, getFeedbackCardClassName, getFeedbackReason, shouldShowCorrectAnswer } from "./dragDropFeedbackCardView.js";

export default function DragDropFeedbackCard(props) {
