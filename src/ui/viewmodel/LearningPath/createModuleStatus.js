...
export default function createModuleStatus({ completionPercent, completedSessions, isCurrent, isUnlocked }) {
	...
	if (completionPercent >= 100) return { statusKey: "completed", appearance: "completed", iconKey: "check" };
	if (completedSessions > 0) return { statusKey: "progress", appearance: "progress", iconKey: "trending" };
