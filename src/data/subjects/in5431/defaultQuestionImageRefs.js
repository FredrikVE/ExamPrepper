...
const COMMON_MOCK_EXAM_4 = {
    ...
    28: [D4D_OVERVIEW, OB, SCI, DP, AF, EXDP],
    29: [D4D_OVERVIEW],
    30: [DECISION_RIGHTS_MATRIX],
    ...
    42: [TOGAF_ADM_EN, TOGAF_ADM_NO],
    43: [TOGAF_TAXONOMY, TOGAF_ADM_EN]
};
...
export const in5431DefaultQuestionImageRefsByExamKey = {
    ...
    "mock-exam-sustainability:no": {
        ...
        17: [SCOPE_1_2_3_MODEL, SCOPE_1_2_3],
        18: [SCOPE_1_2_3_MODEL, SCOPE_1_2_3],
        19: [DOUBLE_MATERIALITY, SCOPE_1_2_3_MODEL, SCOPE_1_2_3],
        22: [TWIN_TRANSITIONS],
