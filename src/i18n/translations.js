...
export const translations = {
    [LANGUAGES.NO]: {
        ...
        learningPathProgressHistoryHeading: "Progresjon og historikk",
        ...
        learningPathReviewBody: (position, title) => `En kort repetisjonsøkt er klar i Del ${position}: ${title}.`,
        learningPathRepairBody: (position, title) => `En målrettet oppfølgingsøkt er klar i Del ${position}: ${title}.`,
        learningPathCoverageBody: (position, title) => `En ekstra måleøkt er klar i Del ${position}: ${title}.`,
        learningPathStartReviewLabel: "Start repetisjon",
        learningPathStartRepairLabel: "Start oppfølging",
        learningPathStartCoverageLabel: "Start måleøkt",
        learningPathResumeTitle: "Fortsett der du slapp",
        learningPathResumeBody: (position, title, question) => `Fortsett Del ${position}: ${title} fra oppgave ${question}.`,
        learningPathResumeLabel: "Fortsett sti",
        learningPathReplayModuleLabel: "Ta på nytt",
        learningPathContinueReplayLabel: (completed, total) => `Fortsett gjennomgang · ${completed} av ${total}`,
        ...
        learningPathConflictTitle: "Du har en økt på gang",
        learningPathConflictBody: "Du kan fortsette den aktive økten, eller forkaste den og starte denne.",
        learningPathConflictContinueLabel: "Fortsett økten",
        learningPathConflictDiscardLabel: "Forkast og start denne",
        learningPathConflictCancelLabel: "Avbryt",
        ...
        learningPathExamUnlockedLabel: "Klar til å startes",
        ...
        learningSessionAuthoredLabel: "Planlagt økt",
        learningSessionReviewLabel: "Repetisjon",
        learningSessionRepairLabel: "Målrettet oppfølging",
        learningSessionCoverageLabel: "Dekningsøkt",
    ...
    [LANGUAGES.EN]: {
        ...
        learningPathReviewBody: (position, title) => `A short review session is ready in Part ${position}: ${title}.`,
        learningPathRepairBody: (position, title) => `A targeted follow-up session is ready in Part ${position}: ${title}.`,
        learningPathCoverageBody: (position, title) => `An extra coverage session is ready in Part ${position}: ${title}.`,
        learningPathStartReviewLabel: "Start review",
        learningPathStartRepairLabel: "Start follow-up",
        learningPathStartCoverageLabel: "Start coverage session",
        learningPathResumeTitle: "Continue where you left off",
        learningPathResumeBody: (position, title, question) => `Continue Part ${position}: ${title} from question ${question}.`,
        learningPathResumeLabel: "Continue path",
        learningPathReplayModuleLabel: "Take again",
        learningPathContinueReplayLabel: (completed, total) => `Continue review · ${completed} of ${total}`,
        ...
        learningPathConflictTitle: "You have a session in progress",
        learningPathConflictBody: "You can continue the active session, or discard it and start this one.",
        learningPathConflictContinueLabel: "Continue session",
        learningPathConflictDiscardLabel: "Discard and start this one",
        learningPathConflictCancelLabel: "Cancel",
        ...
        learningPathExamUnlockedLabel: "Ready to start",
        ...
        learningSessionAuthoredLabel: "Planned session",
        learningSessionReviewLabel: "Review",
        learningSessionRepairLabel: "Targeted follow-up",
        learningSessionCoverageLabel: "Coverage session",
