...
export const translations = {
    [LANGUAGES.NO]: {
        ...
        learningSessionResultMediumTitle: "Økten er fullført",
        ...
        learningSessionResultStrongBody: (moduleTitle) => `Du fullførte økten i ${moduleTitle} med et sterkt resultat.`,
        learningSessionResultMediumBody: (moduleTitle) => `Du fullførte økten i ${moduleTitle}. Se resultatet før du går videre.`,
        learningSessionResultWeakBody: (moduleTitle) => `Økten i ${moduleTitle} er fullført. Læringsstien kan foreslå oppfølging ved behov.`,
    ...
    [LANGUAGES.EN]: {
        ...
        learningSessionResultStrongBody: (moduleTitle) => `You completed the session in ${moduleTitle} with a strong result.`,
        learningSessionResultMediumBody: (moduleTitle) => `You completed the session in ${moduleTitle}. Review the result before continuing.`,
        learningSessionResultWeakBody: (moduleTitle) => `The session in ${moduleTitle} is complete. The learning path can suggest follow-up when needed.`,
