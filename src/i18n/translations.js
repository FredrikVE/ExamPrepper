...
export const translations = {
    [LANGUAGES.NO]: {
        ...
        learningPathContinueTitle: "Fortsett læringen",
        learningPathContinueLabel: "Fortsett",
        learningPathContinueBody: (position, title) => `Start neste økt i Del ${position}: ${title}.`,
        ...
        learningPathStatusWeakRound: (round) => `Øve mer · runde ${round} av 3`,
        learningPathStatusNotStartedRound: (round) => `Ikke startet i runde ${round}`,
    ...
    [LANGUAGES.EN]: {
        ...
        learningPathContinueTitle: "Continue learning",
        learningPathContinueLabel: "Continue",
        learningPathContinueBody: (position, title) => `Start the next session in Part ${position}: ${title}.`,
        ...
        learningPathRetryModuleLabel: "Retry module",
        learningPathStatusActiveRound: (round) => `In progress · round ${round} of 3`,
        learningPathStatusStrongRound: (round) => `Strong · round ${round} of 3`,
        learningPathStatusMediumRound: (round) => `Developing · round ${round} of 3`,
        learningPathStatusWeakRound: (round) => `Needs practice · round ${round} of 3`,
        learningPathStatusNotStartedRound: (round) => `Not started in round ${round}`,
