...
export const translations = {
    [LANGUAGES.NO]: {
        ...
        learningPathMasteryLabel: (percentage) => `${percentage}% mestring`,
        learningPathRoundLabel: (round) => `Runde ${round} av 3`,
        learningPathStartLabel: "Start økt",
        learningPathContinueLabel: "Fortsett",
		learningPathAdaptiveTitle: "Anbefalt neste økt",
		learningPathAdaptiveInitialExposureBody: (position, title) => `Neste økt i Del ${position}: ${title} introduserer begreper du ikke har vurdert ennå.`,
		learningPathAdaptivePracticeBody: (position, title) => `Neste økt i Del ${position}: ${title} prioriterer begreper du bør øve mer på.`,
		learningPathAdaptiveProgressionBody: (position, title) => `Neste økt i Del ${position}: ${title} øker vanskelighetsgraden der du er underveis.`,
		learningPathAdaptiveRevisitBody: (position, title) => `Neste økt i Del ${position}: ${title} repeterer sterke begreper i en ny kontekst.`,
		learningPathAdaptiveRepairBody: (position, title) => `Neste økt i Del ${position}: ${title} prioriterer et svakt forkunnskapsbegrep som støtter det du jobber med nå.`,
        ...
        learningPathToggleDetailsLabel: (title) => `Vis progresjon og historikk for ${title}`,
        learningPathDetailHeading: "Progresjon og historikk",
        learningPathNoTopicProgressLabel: "Ikke startet",
        learningPathTopicNotMeasuredLabel: "Ikke målt",
        ...
        learningPathExamLockedLabel: (rounds) => `Åpner når alle deler har ${rounds} fullførte runder`,
        ...
        learningSessionResultHeaderLabel: "Runde fullført",
        learningSessionResultEyebrow: (round) => `Runde ${round} fullført`,
        learningSessionResultPerfectTitle: "Alle riktige!",
        learningSessionResultStrongTitle: "Flott jobbet!",
        learningSessionResultMediumTitle: "Runden er fullført",
        learningSessionResultWeakTitle: "Nesten der",
        learningSessionResultPerfectBody: (round, moduleTitle) => `Du fullførte runde ${round} i ${moduleTitle} uten en eneste feil.`,
        learningSessionResultStrongBody: (round, moduleTitle) => `Du fullførte runde ${round} i ${moduleTitle} med god måloppnåelse.`,
        learningSessionResultMediumBody: (round, moduleTitle) => `Du fullførte runde ${round} i ${moduleTitle}. Se resultatet før du går videre.`,
        learningSessionResultWeakBody: (round, moduleTitle) => `Runde ${round} i ${moduleTitle} er fullført. En ny gjennomgang kan løfte måloppnåelsen.`,
        learningSessionResultStatsLabel: "Resultat for runden",
        learningSessionResultPointsLabel: "poeng denne runden",
        learningSessionResultRoundScoreLabel: "rundescore",
        learningSessionResultModuleMasteryLabel: "måloppnåelse i modulen",
        learningSessionResultNextStepLabel: "Neste steg",
        learningSessionResultAllRoundsCompleteBody: "Alle tre runder er gjennomført. Fortsett i læringsstien når du er klar.",
        learningSessionResultNextRoundBody: (nextRound) => `Ta en kort pause, eller fortsett direkte til runde ${nextRound}.`,
        learningSessionResultContinueRoundLabel: (nextRound) => `Fortsett til runde ${nextRound}`,
        learningSessionResultStartingRoundLabel: (nextRound) => `Starter runde ${nextRound} …`,
        learningSessionResultEndSessionLabel: "Avslutt økt",
        learningSessionResultContinuePathLabel: "Fortsett sti",
        learningSessionNextRoundStartErrorMessage: "Kunne ikke starte neste runde. Prøv igjen eller avslutt økten.",
        ...
        learningSessionRoundLabel: (round) => `Runde ${round} av 3`,
        ...
        glossaryPageNetworkInstructions: "Velg et nabobegrep for å sentrere nettverket på nytt.",
    ...
    [LANGUAGES.EN]: {
        ...
        learningPathMasteryLabel: (percentage) => `${percentage}% mastery`,
        learningPathRoundLabel: (round) => `Round ${round} of 3`,
        learningPathStartLabel: "Start session",
        learningPathContinueLabel: "Continue",
		learningPathAdaptiveTitle: "Recommended next session",
		learningPathAdaptiveInitialExposureBody: (position, title) => `The next session in Part ${position}: ${title} introduces concepts you have not assessed yet.`,
		learningPathAdaptivePracticeBody: (position, title) => `The next session in Part ${position}: ${title} prioritizes concepts that need more practice.`,
		learningPathAdaptiveProgressionBody: (position, title) => `The next session in Part ${position}: ${title} increases difficulty where you are making progress.`,
		learningPathAdaptiveRevisitBody: (position, title) => `The next session in Part ${position}: ${title} revisits strong concepts in a new context.`,
		learningPathAdaptiveRepairBody: (position, title) => `The next session in Part ${position}: ${title} prioritizes a weak prerequisite that supports what you are learning now.`,
        ...
        learningPathToggleDetailsLabel: (title) => `Show progress and history for ${title}`,
        learningPathDetailHeading: "Progress and history",
        learningPathNoTopicProgressLabel: "Not started",
        learningPathTopicNotMeasuredLabel: "Not measured",
        learningPathTopicProgressLabel: (percentage) => `${percentage}%`,
        learningPathStartRoundLabel: (round) => `Start round ${round}`,
        learningPathContinueRoundLabel: (round) => `Continue round ${round}`,
        learningPathStatusActiveRound: (round) => `In progress · round ${round} of 3`,
        learningPathExamTitle: "Exam",
        learningPathExamUnlockedLabel: "Ready to start",
        learningPathExamLockedLabel: (rounds) => `Unlocks when every part has ${rounds} completed rounds`,
        ...
        learningSessionResultHeaderLabel: "Round completed",
        ...
        learningSessionResultPerfectBody: (round, moduleTitle) => `You completed round ${round} in ${moduleTitle} without a single mistake.`,
        learningSessionResultStrongBody: (round, moduleTitle) => `You completed round ${round} in ${moduleTitle} with strong mastery.`,
        learningSessionResultMediumBody: (round, moduleTitle) => `You completed round ${round} in ${moduleTitle}. Review the result before continuing.`,
        learningSessionResultWeakBody: (round, moduleTitle) => `Round ${round} in ${moduleTitle} is complete. Another attempt can improve your mastery.`,
        ...
        learningSessionResultAllRoundsCompleteBody: "All three rounds are complete. Continue on the learning path when you are ready.",
        learningSessionResultNextRoundBody: (nextRound) => `Take a short break, or continue directly to round ${nextRound}.`,
        ...
        learningSessionNextRoundStartErrorMessage: "Could not start the next round. Try again or end the session.",
        ...
        learningSessionRoundLabel: (round) => `Round ${round} of 3`,
        ...
        glossaryPageImportanceColumnHeader: "Importance",
        ...
        glossaryPageConnectionsColumnHeader: "Connections",
        glossaryPageMasteryColumnHeader: "Mastery",
        glossaryPageOpenNetworkLabel: "Show network",
        ...
        glossaryPageNetworkTitle: "Concept network",
        glossaryPageNetworkInstructions: "Select a neighboring concept to recenter the network.",
        glossaryPageNetworkCloseLabel: "Close network",
